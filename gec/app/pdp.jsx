            ...
            <ScrollView>
                ...
                <View style={styles.tempoffer}>
                    <Text style={styles.offerMain}>
                        SAVE UP TO 15% ON SELECT FLOOR CARE MACHINES - ENDS NOV 30 | SHOP NOW
                    </Text>
                ...
                <View style={styles.breadcrumbOuter}>
                    <ScrollView
                        ...
                        <Text style={styles.breadcrumbText}>
                            Home {'  >  '} Storage & Shelving {'  >  '} Cabinets {'  >  '} Safety Cabinets {'  >  '} Flammable Materials Cabinets {'  >  '} Flammable Safety Cabinets
                        </Text>
                    </ScrollView>
                </View>
                            ...
                            <View style={styles.modalContent}>
                                {options.map((item) => (
                                    <TouchableOpacity key={item}
                                        ...
                                        <Text style={[styles.modalItemText, item === quantity && styles.modalItemTextSelected]} > {item} </Text>
                                    </TouchableOpacity>
                                ))}
                            </View>
                        </TouchableOpacity>
                ...
                <View style={styles.accordionSection}>
                    <Accordion title="Product Description" variant="pdp">
                        <Text style={styles.accordionContentText}>
                            ...
                            <Text style={styles.check}>✓</Text> Flush door handle prevents employees from catching or banging into cabinet{'\n\n'}

                            <Text style={styles.paragraph}>
                                Provide additional fire protection in your workspace with the Global Industrial™ Flammable Cabinet with Manual Close Doors. Featuring an all-welded construction for long-lasting durability, this 18-gauge steel cabinet with 14-gauge steel doors has three shelves, two of which are adjustable, to safely store up to 45-gallons of flammable liquids. The double-walled design allows for 1-1/2" of insulating air space, while the dual 2" air vents connect to exhaust systems to maintain safe temperatures. This unit is equipped with full-length piano hinges and a spill-proof sill for convenient spill management.
                            </Text>{'\n\n'}

                            Meets NFPA Flammable Liquid Code #30 & the OSHA Standard 1910.106 for storage of class I, II, and III liquids{'\n'}
                            FM-approved{'\n'}
                            ...
                            Some states and municipalities may require self-closing doors on flammable safety cabinets; please review your local ordinances prior to purchasing
                        </Text>
                    </Accordion>
